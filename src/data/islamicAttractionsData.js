export const islamicAttractionsData = {
  ...
  data: [
    {
      image: require("../images/Where to Go/Islamic Attractions/Citadel_of_Saladin.jpg"),
      title: "The Citadel of Salah El-Din",
      classification: "Attractions",
    },
    {
      image: require("../images/Where to Go/Islamic Attractions/al-azhar-mosque.jpg"),
      title: "Al-Azhar Mosque",
      classification: "Attractions",
    },
    {
      image: require("../images/Where to Go/Islamic Attractions/ibn-tulun.jpg"),
      title: "Ibn Tulun Mosque",
      classification: "Attractions",
    },
    {
      image: require("../images/Where to Go/Islamic Attractions/Mosque-Madrassa_of_Sultan_Hassan_-_Cairo_2.jpg"),
      title: "The Sultan Hassan Mosque",
      classification: "Attractions",
    },
    {
      image: require("../images/Where to Go/Islamic Attractions/al-hussein.jpg"),
      title: "The Al-Hussein Mosque",
      classification: "Attractions",
    },
  ],
};

export const localsData = [
  {
    ...
    favoriteSpots: [
      ...
      },
      {
        ...
        classification: "Club",
        link: "https://www.google.com/maps/place/Cairo+Jazz+Club/@30.0621816,31.2093212,17z/data=!3m2!4b1!5s0x1458411f3ade9195:0x7f751a69d0757691!4m6!3m5!1s0x1458413f3dedb98f:0x5b4219ebdbdb6333!8m2!3d30.062177!4d31.2119015!16s%2Fg%2F11y0l8y4d?authuser=0",
  ...
  },
  {
    ...
    title: "Hana Moustafa",
    classification: "local in cairo",
    quote: "'Cairo is my canvas and the city's architecture is my muse.'",
    about:
      "Hana is a young local artist living in Cairo, Egypt. Her passion for modern architecture has led her to explore the city's lesser-known spots and capture their beauty through her photography. Hana's artistic eye and attention to detail allow her to showcase Cairo's true spirit in her work. She believes that every street, building, and corner of the city has its unique story and charm, waiting to be discovered and shared with the world. For Hana, Cairo is not just a city but a canvas, and she considers herself fortunate to be able to capture its essence through her art.",
    guides: [
      {
    ...
    favoriteSpots: [
      {
        ...
        description:
          "The Cairo Tower is one of my favorite spots in the city because it offers a panoramic view of Cairo's modern architecture. It is the perfect place to take breathtaking photos and appreciate the city's beauty.",
      },
      {
        image: require("../images/Local Page/Amira Fathi/spots/Egyptian-Museum-Cairo.jpg"),
        title: "The Grand Nile Tower Hotel",
        classification: "Hotel",
        link: "https://goo.gl/maps/vzupZ3qj1EYDC1Gm8",
        description:
          "The Grand Nile Tower Hotel is a luxurious hotel that embodies my love for modern architecture. The hotel's design is sleek and elegant, and it offers amazing views of the Nile River.",
      },
      {
        image: require("../images/Local Page/Amira Fathi/spots/Egyptian-Museum-Cairo.jpg"),
        ...
        description:
          "The Garden Cafe is a cozy and charming cafe located in Zamalek. It is one of my favorite spots to relax, enjoy a cup of coffee, and get some work done.",
      },
      {
        image: require("../images/Local Page/Amira Fathi/spots/Egyptian-Museum-Cairo.jpg"),
        title: "The Egyptian Museum",
        classification: "Attraction",
        link: "https://goo.gl/maps/tK99yhvZ9tkKjJjo7",
        description:
          "The Egyptian Museum is a must-visit spot for anyone interested in Egyptian history and culture. As an artist, I find inspiration in the museum's collection of ancient Egyptian artifacts.",
      },
      {
        image: require("../images/Local Page/Amira Fathi/spots/Egyptian-Museum-Cairo.jpg"),
        title: "Sequoia",
        classification: "Restaurant",
        link: "https://goo.gl/maps/1LShJ2aLH5jyaURt9",
        description:
          "Sequoia is a stunning restaurant located in the Zamalek neighborhood. It is situated on a terrace overlooking the Nile River, offering breathtaking views of the city. The restaurant's decor is modern and chic, featuring large glass windows and sleek furniture. I love coming to Sequoia for a special occasion or a romantic night out with friends. The menu offers a variety of Mediterranean and Middle Eastern dishes, all made with high-quality ingredients and beautifully presented.",
      },
    ],
  },
  {
    ...
    title: "Andrew Atef",
    classification: "local in cairo",
    quote: "'Living sustainably in Cairo is not a trend, it's a necessity.'",
    about:
      "Andrew is a young local engineer living in Cairo, Egypt. His passion for sustainability and environmentally friendly living has led him to explore ways to reduce his carbon footprint and live a more eco-friendly lifestyle. He believes that living sustainably in Cairo is not just a trend, but a necessity to protect the environment and create a better future for generations to come. Andrew is also a lover of green spaces and handmade products. He enjoys spending time in Cairo's parks and gardens, and supporting local artisans who create unique and sustainable products. For Andrew, living sustainably is not just a lifestyle, it's a mindset.",
    guides: [
      {
        image: require("../images/Local Page/Andrew Atef/1.jpg"),
        title: "How I Spend a Family Friendly Day in Cairo",
    ...
    favoriteSpots: [
      {
        ...
        link: "https://goo.gl/maps/F9aj9RfRjcHfhfbDA",
        description:
          "Al-Azhar Park is a beautiful green space in the heart of Cairo. It is one of my favorite spots to relax, meditate, and connect with nature. The park is also home to many environmentally friendly initiatives and sustainable practices, such as water conservation and organic farming.",
      },
      {
        image: require("../images/Local Page/Amira Fathi/spots/Egyptian-Museum-Cairo.jpg"),
        title: "Mounir Restaurant",
        classification: "Restaurant",
        link: "https://goo.gl/maps/vzupZ3qj1EYDC1Gm8",
        description:
          "Mounir Restaurant is a local favorite that serves delicious Egyptian cuisine. What I love about this restaurant is that it uses fresh, locally sourced ingredients and supports small-scale farmers and producers. The restaurant also has a cozy, home-like atmosphere that makes me feel like I'm eating with family.",
      },
      {
        image: require("../images/Local Page/Amira Fathi/spots/Egyptian-Museum-Cairo.jpg"),
        title: "Zee Bazaar",
        ...
        link: "https://goo.gl/maps/4n8f4gbUcB6KsYdS7",
        description:
          "Zee Bazaar is a unique store that sells handmade and eco-friendly products from local artisans. It is one of my favorite spots to shop for sustainable and ethical products, such as organic clothing, handmade soaps, and recycled accessories. What I appreciate about Zee Bazaar is that it supports local communities and promotes a more sustainable and conscious way of living.",
      },
    ],
  },
  {
